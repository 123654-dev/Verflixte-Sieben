...
public class GUI implements ActionListener
{
    ...
    public GUI() {
        ...
        // Font wird  ver�ndert/ Schriftgr��e und Farbe
        ...
        punkte1.setFont(fontABC);
        punkte1.setForeground (Color.white);
        punkte2.setFont(fontABC);
        punkte2.setForeground (Color.white);
